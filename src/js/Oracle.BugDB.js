...
Oracle = (function (parent) {
    ...
    const _fieldProperties = {
        number: { id:'number', columnTitle: 'Number', headerTitle: 'Num', sectionTitle: 'Numbers',  type: 'number', formater: 'BugDBNumber', groupable: false }, 
        assignee: { id:'assignee', columnTitle: 'Assignee', headerTitle: 'Assignee', filterId:'assignees', filterTitle: 'Assignees', groupable: true }, 
        severity: { id:'severity', columnTitle: 'Severity', headerTitle: 'Sev', lookup: result.Severity, formater: 'BugDBSeverity', filterId:'severity', filterTitle: 'Severity', groupable: true }, 
        component: { id:'component', columnTitle: 'Component', headerTitle: 'Component', filterId:'components', filterTitle: 'Components', groupable: true } , 
        ...
        tags: { id:'tags', columnTitle: 'Tags', headerTitle: 'Tag', lookup: result.Tag, formater: 'BugDBTag', filterId:'tags', filterTitle: 'Tags', groupable: false }, 
        customer: { id:'customer', columnTitle: 'Customer', headerTitle: 'Customer', filterId:'customer', filterTitle: 'Customers', formater: 'BugDBCustomer', groupable: true }, 

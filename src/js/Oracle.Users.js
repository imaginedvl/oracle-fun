...
Oracle = (function (parent) {
    ...
    const _userClass = class{
        ...
        getSortString()
        {
            ...
            {
                return "Z" + this.globalId;
            }
            else{
                return "A" + this.globalId;
            }
        }
    ...
    Oracle.addKnownClass("User", value => value instanceof _userClass, (a, b) => a.getSortString().localeCompare(b.getSortString()) );
    ...
    Oracle.HTML.addStyle('.oracle-user { }');
    Oracle.HTML.addStyle('.oracle-user.internal { font-weight:600;  }');
    Oracle.HTML.addStyle('.oracle-user.group { color:#999  }');
